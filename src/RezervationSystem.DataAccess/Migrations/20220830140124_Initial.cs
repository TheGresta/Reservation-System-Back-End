    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 0, null, new DateTime(2022, 9, 2, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(843), 1, new DateTime(2022, 8, 30, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(834), null, null },
                    { 2, null, 0, null, new DateTime(2022, 9, 2, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(849), 2, new DateTime(2022, 8, 30, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(849), null, null },
                    { 3, null, 0, null, new DateTime(2022, 9, 2, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(852), 3, new DateTime(2022, 8, 30, 17, 1, 24, 643, DateTimeKind.Local).AddTicks(851), null, null }
                });
